  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <p className="text-sm text-gray-600">Agents pointés</p>
          <p className="text-3xl font-bold text-blue-600">{filledRows} / {agents.length}</p>
        </div>
            ...
            <tbody className="divide-y divide-gray-200">
              {agents.map((agent) => {
                ...
                return (
                  <tr
                    key={agent.id}
                    className={`hover:bg-gray-50 transition-colors ${hasProject ? 'bg-orange-50' : ''}`}
                  >
